(() => {
  ...
  if(headerVersion) headerVersion.textContent='Scanner de minifigurines · v2.11';
  const scanStatus=$('scanStatus');
  if(scanStatus && /Prêt/.test(scanStatus.textContent||'')) scanStatus.textContent='Prêt · v2.11';
  document.title='BrickScan Mini 2.11';
  ...
  let latestVersion=APP_VERSION, latestBuild=2110;
