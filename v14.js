(() => {
  ...
  let latestVersion=APP_VERSION, latestBuild=170;
  ...
  const infoCard=document.querySelector('#infoView .info-card');if(infoCard&&!infoCard.querySelector('.image-credit')){const credit=document.createElement('div');credit.className='image-credit';credit.innerHTML='Photos des séries récentes chargées depuis L-Scan et BrickLink. Les marques et visuels LEGO restent la propriété de leurs ayants droit.';infoCard.appendChild(credit);}
})();
