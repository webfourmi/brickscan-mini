(() => {
  ...
  if(headerVersion) headerVersion.textContent='Scanner de minifigurines · v2.10.1';
  const scanStatus=$('scanStatus');
  if(scanStatus && /Prêt/.test(scanStatus.textContent||'')) scanStatus.textContent='Prêt · v2.10.1';
  document.title='BrickScan Mini 2.10.1';
  ...
  let latestVersion=APP_VERSION, latestBuild=211;
