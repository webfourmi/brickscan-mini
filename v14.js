(() => {
  ...
  if(headerVersion) headerVersion.textContent='Scanner de minifigurines · v2.0.1';
  const scanStatus=$('scanStatus');
  if(scanStatus && /Prêt/.test(scanStatus.textContent||'')) scanStatus.textContent='Prêt · v2.0.1';
  document.title='BrickScan Mini 2.0.1';
  ...
  let latestVersion=APP_VERSION, latestBuild=201;
