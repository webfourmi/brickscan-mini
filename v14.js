(() => {
  ...
  if(headerVersion) headerVersion.textContent='Scanner de minifigurines · v2.5';
  const scanStatus=$('scanStatus');
  if(scanStatus && /Prêt/.test(scanStatus.textContent||'')) scanStatus.textContent='Prêt · v2.5';
  document.title='BrickScan Mini 2.5';
  ...
  let latestVersion=APP_VERSION, latestBuild=250;
