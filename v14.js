(() => {
  ...
  if(headerVersion) headerVersion.textContent='Scanner de minifigurines · v2.3';
  const scanStatus=$('scanStatus');
  if(scanStatus && /Prêt/.test(scanStatus.textContent||'')) scanStatus.textContent='Prêt · v2.3';
  document.title='BrickScan Mini 2.3';
  ...
  let latestVersion=APP_VERSION, latestBuild=230;
