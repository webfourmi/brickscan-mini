(() => {
  ...
  if (!document.querySelector('script[data-brickscan-scanner-v282]')) {
    ...
    scanner.src = 'scanner-v282.js?v=2121';
  ...
  if (!document.querySelector('script[data-brickscan-v285]')) {
    ...
    wishlistRule.src = 'v285.js?v=2121';
  ...
  if (!document.querySelector('script[data-brickscan-v29]')) {
    ...
    visualScanner.src = 'v29.js?v=2121';
  ...
  if (!document.querySelector('script[data-brickscan-v210]')) {
    ...
    lists.src = 'v210.js?v=2121';
    lists.dataset.brickscanV210 = 'true';
    document.body.appendChild(lists);
  }

  if (!document.querySelector('script[data-brickscan-v2112]')) {
    const historyFix = document.createElement('script');
    historyFix.src = 'v2112.js?v=2121';
    historyFix.dataset.brickscanV2112 = 'true';
    document.body.appendChild(historyFix);
  }
  ...
  setTimeout(() => {
    ...
    if (headerVersion) headerVersion.textContent = 'Scanner de minifigurines · v2.12.1.1';
    const scanStatus = document.getElementById('scanStatus');
    if (scanStatus && /Prêt/.test(scanStatus.textContent || '')) scanStatus.textContent = 'Prêt · v2.12.1.1';
    const currentVersion = document.getElementById('currentVersion');
    if (currentVersion) currentVersion.textContent = APP_VERSION;
    document.title = 'BrickScan Mini 2.12.1';
  }, 0);
})();