(() => {
  ...
  if (!document.querySelector('script[data-brickscan-scanner-v282]')) {
    ...
    scanner.src = 'scanner-v282.js?v=2120';
  ...
  if (!document.querySelector('script[data-brickscan-v285]')) {
    ...
    wishlistRule.src = 'v285.js?v=2120';
  ...
  if (!document.querySelector('script[data-brickscan-v29]')) {
    ...
    visualScanner.src = 'v29.js?v=2120';
  ...
  if (!document.querySelector('script[data-brickscan-v2112]')) {
    ...
    historyFix.src = 'v2112.js?v=2120';
  ...
  setTimeout(() => {
    ...
    if (headerVersion) headerVersion.textContent = 'Scanner de minifigurines · v2.12.0';
    const scanStatus = document.getElementById('scanStatus');
    if (scanStatus && /Prêt/.test(scanStatus.textContent || '')) scanStatus.textContent = 'Prêt · v2.12.0';
    const currentVersion = document.getElementById('currentVersion');
    if (currentVersion) currentVersion.textContent = APP_VERSION;
    document.title = 'BrickScan Mini 2.12.0';
  }, 0);
})();